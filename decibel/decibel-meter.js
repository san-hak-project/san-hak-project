var DecibelMeter = (function (window, navigator, document, undefined) {
  ...
  DecibelMeter.prototype.connect = function (source, callback) {
    ...
    if (typeof source === "string" || typeof source === "number") {
      ...
      if (!source) throw new Error("DecibelMeter: Attempted to select invalid audio source");
    }
  ...
  DecibelMeter.prototype.listen = function () {
    ...
    if (this.source === null) throw new Error("DecibelMeter: No source selected");

    if (this.connection === null) throw new Error("DecibelMeter: Not connected to source");
      ...
      if (meter.listening && meter.handle.sample) {
        ...
        var value = meter.connection.lastSample[0],
          ...
          dB =
            ...
            (meter.connection.analyser.maxDecibels - meter.connection.analyser.minDecibels) *
              percent;
